...
import { ApiNotFoundResponse, ApiOkResponse, ApiTags, ApiBadRequestResponse, ApiGatewayTimeoutResponse } from '@nestjs/swagger';
...
export class OrdersController {
  ...
  @ApiNotFoundResponse({description: 'Record with given order number not found'})
  ...
  @Patch(':orderNumber')
  @ApiOkResponse({type: OrderEntity})
  @ApiNotFoundResponse({description: 'Record with the given order number not found'})
